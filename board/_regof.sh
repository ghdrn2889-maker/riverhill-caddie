...
for f in $M; do
  a=$(run $f "390 844 C:/Users/ghdrn/Documents/board16m_ofbefore.html")
  b=$(run $f "390 844 C:/Users/ghdrn/Documents/board16m.html")
  [ "$a" != "$b" ] && { echo "폰 $f  전$a 후$b  ★달라짐"; n=$((n+1)); }
done
for f in $P; do
  a=$(run $f "1600 1000 C:/Users/ghdrn/Documents/board16_ofbefore.html")
  b=$(run $f "1600 1000 C:/Users/ghdrn/Documents/board16.html")
  [ "$a" != "$b" ] && { echo "PC $f  전$a 후$b  ★달라짐"; n=$((n+1)); }
done
echo "── 달라진 프로브 $n 개 / 총 67개 (_probeBulkFind 2개는 없앤 창을 시험하던 것이라 뺌)"
