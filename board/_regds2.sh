...
cd "$(dirname "$0")"
M="_probeTee3 _probeTee _probeTeamDel _probeStray _probeBu3In2 _probeClear _probeMove39 _probeExact _probeAddTeam _probeJoIn _probeSwapOff _probeAddBack2 _probeRoundClash _probeWkQ _probeEmptySeat _probeLnWait _probeSeatVac _probeLnOrder _probeCartLend2 _probeCart _probePool _probeCarryOpt _probeCarryDiag _probeBulkFind _probeNoSeat _probeSwapList _probeAbs _probeWhy23 _probeRestUI _probeSeatTag _probeJochul _probeBu3Set _probeWipe _probeWkBadge _probeDayTag _probeDraftUndo _probeCatchUp _probeDayTap _probeMigrate _probeDays _probeSave _probePmStay _probeUnplaced _probePartMove _probeCarryUI _probeCarry _probeBu3UI _probeBu3 _probeWkOrder _probeLnUI _probeLineup _probeBulk"
