...
function renderToday(t) {
  ...
  //  ★'화면이 보는 날짜'의 당번만 온다 — 서버가 tISO 기준으로 골라 내려준다.
  //   그래서 오늘 끝난 당번이 내일 화면에 '마쳤어요'로 남지 않는다(그 걱정 때문에 옛 빗장이 있었다).
...
const LG_FEE_TABLE = [
  // 홀정산(전반 중단) 감액은 안 올랐다 — 1·2부 7만 그대로.
  { from: '2026-09-07', fees: { 1: 150000, 2: 150000, 3: 150000 }, hole: { 1: 70000, 2: 70000, 3: 80000 } },
